...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h2 class="hero-title">Medeniyetlerin Beşiği Türkiye'yi Keşfedin</h2>
            <p class="hero-subtitle">Binlerce yıllık tarihi, eşsiz doğal güzellikleri ve zengin kültürüyle unutulmaz bir deneyim</p>
            <a href="#destinasyonlar" class="btn-primary hero-btn">Keşfetmeye Başla</a>
        </div>
    </section>
    ...
    <main>
        ...
        <section id="destinasyonlar" class="destinations">
            <div class="container">
                <h2 class="section-title animate-on-scroll">Popüler Destinasyonlar</h2>
        ...
        <section id="kultur" class="culture">
            <div class="container">
                <h2 class="section-title animate-on-scroll">Kültür & Tarih</h2>
                <div class="culture-content">
                    <div class="culture-text animate-on-scroll">
                        <p>
                    ...
                    <div class="culture-img animate-on-scroll"></div>
                </div>
            </div>
        </section>
        ...
        <section id="mutfak" class="cuisine">
            <div class="container">
                <h2 class="section-title animate-on-scroll">Türk Mutfağı</h2>
                ...
                <div class="cuisine-grid">
                    <div class="cuisine-item animate-on-scroll">
        ...
        <section class="travel-tips">
            <div class="container">
                <h2 class="section-title animate-on-scroll">Seyahat İpuçları</h2>
                <div class="tips-grid">
